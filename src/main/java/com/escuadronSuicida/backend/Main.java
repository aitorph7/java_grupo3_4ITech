...
public class Main {
	...
	public static void main(String[] args) {
		...
		Keynote keynote1 = new Keynote(1L, "Inteligencia Artificial",
				...
				"""
      <p>La Inteligencia Artificial (IA) es un campo de la informática que busca <strong>crear máquinas capaces de realizar tareas que típicamente requieren inteligencia humana</strong>. Esto incluye el aprendizaje, el razonamiento, la resolución de problemas y la toma de decisiones.</p><p><strong>¿Cómo funciona la IA?</strong></p><p>La IA funciona utilizando una variedad de técnicas, incluyendo:</p><ul><li><strong>Aprendizaje automático:</strong>&nbsp;La IA aprende a partir de datos, identificando patrones y relaciones sin necesidad de ser programada explícitamente.</li><li><strong>Procesamiento del lenguaje natural:</strong>&nbsp;La IA procesa y comprende el lenguaje humano, permitiendo la comunicación entre humanos y máquinas.</li><li><strong>Visión artificial:</strong>&nbsp;La IA interpreta y analiza imágenes y videos del mundo real.</li><li><strong>Robótica:</strong>&nbsp;La IA controla y opera robots físicos, permitiendo la automatización de tareas.</li></ul><p><strong>¿Cuáles son las aplicaciones de la IA?</strong></p><p>La IA tiene una amplia gama de aplicaciones en diversos sectores, como:</p><ul><li><strong>Salud:</strong>&nbsp;La IA se utiliza para desarrollar nuevos medicamentos, diagnosticar enfermedades y brindar atención médica personalizada.</li><li><strong>Finanzas:</strong>&nbsp;La IA se utiliza para detectar fraudes, gestionar inversiones y asesorar a clientes financieros.</li><li><strong>Transporte:</strong>&nbsp;La IA se utiliza para desarrollar vehículos autónomos, optimizar el tráfico y mejorar la seguridad vial.</li><li><strong>Manufactura:</strong>&nbsp;La IA se utiliza para automatizar tareas de producción, optimizar la cadena de suministro y mejorar la calidad del producto.</li><li><strong>Agricultura:</strong>&nbsp;La IA se utiliza para optimizar el riego, la fertilización y la cosecha, y para predecir el rendimiento de los cultivos.</li></ul><p><strong>¿Cuál es el impacto de la IA?</strong></p><p>La IA tiene el potencial de generar un impacto significativo en la sociedad, tanto positivo como negativo. Es importante considerar cuidadosamente los beneficios y riesgos de la IA a medida que continuamos desarrollándola e implementándola.</p><p><strong>Beneficios potenciales de la IA:</strong></p><ul><li>Mayor eficiencia y productividad</li><li>Mejor toma de decisiones</li><li>Nuevos productos y servicios</li><li>Soluciones a problemas complejos</li></ul><p><strong>Riesgos potenciales de la IA:</strong></p><ul><li>Desempleo</li><li>Discriminación</li><li>Pérdida de privacidad</li><li>Armas autónomas</li></ul><p><strong>¿Qué depara el futuro de la IA?</strong></p><p>La IA es un campo en rápido desarrollo con un enorme potencial para transformar nuestras vidas. A medida que la tecnología continúa avanzando, es probable que veamos aún más aplicaciones innovadoras de la IA en los próximos años.</p><p><strong>Es importante recordar que la IA es una herramienta</strong> y, como cualquier herramienta, puede usarse para el bien o para el mal. Depende de nosotros asegurarnos de que la IA se use de manera responsable y ética para el beneficio de toda la humanidad.</p>
						""","AI_2.png",
